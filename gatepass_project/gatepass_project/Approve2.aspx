<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve2.aspx.cs" Inherits="gatepass_project.Approve2" %>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group text-center">
            <label for="txtApproverEmail"><i class="fas fa-envelope"></i> Your Email:</label>
            <asp:TextBox ID="txtApproverEmail" runat="server" CssClass="form-control w-50 mx-auto" Placeholder="Enter your email" />
        </div>
        <div class="text-center mt-3">
            <asp:Button ID="btnApprove" runat="server" Text="✅ Approve" CssClass="btn btn-success btn-custom" OnClick="btnApprove_Click" Visible="true" data-toggle="tooltip" title="Approve this document" aria-label="Approve document" />         
        </div>
        <div class="form-group text-center mt-3">
            ...
            <div class="progress">
                <div id="progressBar" runat="server" class="progress-bar bg-success" role="progressbar" aria-valuenow="<%# lblApprovalCount.Text %>" aria-valuemin="0" aria-valuemax="2"></div>
            </div>
        </div>
    </div>
</div>
