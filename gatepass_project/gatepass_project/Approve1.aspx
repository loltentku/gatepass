<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve1.aspx.cs" Inherits="gatepass_project.Approve1" %>
...
<div class="card">
    ...
    <asp:TextBox ID="txtApproverEmail" runat="server" CssClass="form-control w-50 mx-auto" Placeholder="Enter your email" />
                        ...
                        <div class="text-center mt-3">
                            <asp:Button ID="btnApprove" runat="server" Text="✅ Approve" CssClass="btn btn-success btn-custom" OnClick="btnApprove_Click" Visible="false" data-toggle="tooltip" title="Approve this document" aria-label="Approve document" />
                                                 </div>
                 <div class="form-group text-center mt-3">
    <h5><strong>Approval Count: </strong><asp:Label ID="lblApprovalCount" runat="server" CssClass="text-primary font-weight-bold"></asp:Label></h5>
    <div class="progress">
