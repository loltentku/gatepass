...
<asp:Button ID="btnAddRow" runat="server" CssClass="btn btn-success"
     ...
     <script>
         $(document).ready(function () {
             ...
             $(document).on("input", ".description, .quantity, .purpose", function () {
                 updateHiddenField();
             });
             ...
             function updateHiddenField() {
                 let itemsData = [];
                 // Select every row that contains an input with the class .description.
                 $("#GridView1 tr").has("input.description").each(function () {
                     // Select the first hidden field in this row.
                     ...
                     // Only push the row if all fields have a value.
                     if (description && quantity && purpose) {
                         itemsData.push({ ItemID: id, Description: description, Quantity: quantity, Purpose: purpose });
                     }
                 });
